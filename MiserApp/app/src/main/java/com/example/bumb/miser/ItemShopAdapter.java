...
public class ItemShopAdapter extends ArrayAdapter<Item>{

    private ShopListFragment myFragment;

    public ItemShopAdapter(@NonNull Context context, int resource, @NonNull List<Item> objects, ShopListFragment myFragment) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.row_layout_shop_list, null);
        }
        ...
        LinearLayout rowLayout = (LinearLayout)rowView.findViewById(R.id.LinearLayoutRow_ShopList);
        ...
        final ImageButton addFavBtn = (ImageButton) rowView.findViewById(R.id.add_to_bought_list_button);
        ...
        //Handle Image button and delete operation
        ImageButton deleteBtn = (ImageButton) rowView.findViewById(R.id.delete_from_shop_list_button);

        deleteBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View rowView) {
                ((MainActivity) myFragment.getActivity()).removeElementAt(position);
            }
        });
